...
CREATE TABLE DIPARTIMENTI(
    ...
    -- Crea vincolo di controllo: tipologia deve essere per forza uno di questi valori
)
...
CREATE TABLE STORICO_SEGNALAZIONI (
    ...
    Via VARCHAR2(35),
    NumeroCivico NUMBER(5),
    Data_Ora TIMESTAMP(0), -- Prende data e ora corrente al momento della creazione
...
GRANT CONNECT TO utente;                                 -- attribuzione dei privilegi: connettersi ad utente
...
GRANT SELECT                 ON sen.SEGNALAZIONI   TO centralinista;
  -- Fa selezioni per prendere richieste che interessano un certo dipartimento
