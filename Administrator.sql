...
CREATE TABLE COINVOLGIMENTI(
 ...
 CREATE ROLE Ut;
    GRANT CONNECT TO Ut;
    GRANT INSERT ON ADMINISTRATOR.RICHIESTE TO Ut;
 
 CREATE ROLE Op;
    GRANT CONNECT TO Op;
    GRANT SELECT, INSERT, DELETE, UPDATE ON ADMINISTRATOR.SEGNALAZIONI TO Op;
...
--  REVOCA PRIVILEGI
 REVOKE SELECT, INSERT, DELETE, UPDATE ON ADMINISTRATOR.SEGNALAZIONI FROM Op;
 REVOKE INSERT ON ADMINISTRATOR.RICHIESTE FROM Ut;
